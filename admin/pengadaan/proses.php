...
$upload = move_uploaded_file($_FILES['file']['tmp_name'],'../berkaspengadaan/'.$nama);

if ($upload) {

$tambah = mysqli_query($koneksi,"INSERT INTO `pengadaan`(`idpengadaan`, `namaberkas`) VALUES (null,'$nama')");
